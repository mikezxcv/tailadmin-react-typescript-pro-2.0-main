...
import { useExpenseReportsManager } from "./api/history.api";
...
export default function HistoryInvoiceManager() {
    ...
    const { data: expenseReportsData = [] } = useExpenseReportsManager(true, userLoggued?.id || 0);
