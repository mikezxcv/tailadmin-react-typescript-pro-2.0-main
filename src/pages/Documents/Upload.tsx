...
export default function Upload() {
  ...
  const handleInvoiceFormBlur = useCallback(
    (invoiceId: number, field: string, e: FocusEvent<HTMLInputElement | HTMLSelectElement>) => {
                ...
                <div className="p-6 border border-gray-200 rounded-xl dark:border-gray-800">
                  ...
                  <div className="space-y-6">
                    {invoices.map((invoice) => {
                      const { values, errors, isFieldInvalid, getFieldError } = invoiceForms[invoice.id];
                      return (
                        <ComponentCard
                          key={invoice.id}
                          ...
                          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "expenseDate", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "employee", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Select
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "country", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Select
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "company", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "localAmount", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Select
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "currency", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "exchangeRate", e)}
                            ...
                            <div className="col-span-2 sm:col-span-1">
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "usdAmount", e)}
                            ...
                            <div className="col-span-2">
                              ...
                              <Input
                                ...
                                onBlur={(e) => handleInvoiceFormBlur(invoice.id, "provider", e)}
